...
contract DSCEngine is ReentrancyGuard {
    ...
    constructor(address[] memory tokenAddresses, address[] memory priceFeedAddresses, address dscAddress) {
        ...
        if (count != priceFeedAddresses.length) {
     ...
     * @param user The user who has a healthFactor below MIN_HEALTH_FACTOR
     * @param debtToCover The amount of DSC to burn to improve the user's health factor
     * @notice The caller can partially liquidate a user.
     * @notice The caller will get a liquidation bonus for taking the user's funds
     * @notice This function working assumes the protocol will be roughly 200% overcollateralized in order for this to work.
     * @notice A known bug would be if the protocol were 100% or less collateralized, then liquidators have no incentive to liquidate.
    ...
    /**
     * Reverts if user's health factor is less than minimum health factor
     * @param user address of the user
     */
     ...
     * @param usdAmountInWei amount of USD in wei
     */
    ...
    /**
     * Returns the total collateral value in USD of the user
     * @param user address of the user
     */
    function getAccountCollateralValue(address user) public view returns (uint256 totalCollateralValueInUSD) {
        uint256 numCollateralTokens = s_collateralTokens.length;
    ...
    /**
     * Returns the USD value from a Chainlink data feed
     * @param token address of token
